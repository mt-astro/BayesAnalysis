...
I actually think this is really interesting, so I made a whole table considering the possible outcomes for different results between first and second tests. For the requested answer (first test positive, second test negative), the final probability that Jow Schmo has _RareDisease120783D_ is `r round(second_test*100., 3)`%. The table itself:
