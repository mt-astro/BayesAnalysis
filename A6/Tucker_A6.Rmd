...
(b) Are distances (from a known fixed point) ratio-scale metric data or interval-scale metric data? Again, a distance such that $d^2 = x^2 + y^2$ on any given coordinate grid, is inherently positive and is ratio-scale.
